...
This is now a **unified flow**:

* Works as a **checklist for real pentests**
* Functions as a **cheat sheet for bug bounties**
* Serves as a **linear attack tree for CTFs/labs**
